...
<body>
    ...
    <div id="jumbotron" class="container">
        <div class="jumbotron jumbotron-info" style="background-color: lightgray;">
            <h1>
                <strong>회원가입</strong>&nbsp;<span class="glyphicon glyphicon glyphicon-pencil"></span>
            </h1>
            <p>회원가입을 환영합니다.</p>
        </div>
    </div>
        ...
        <form id="joinForm" method="post" action="user/userInsert" role="form" autocomplete="off">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group" style="margin-top: 5%;">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type="text" name="user_id" id="user_id" required="required"  autofocus="autofocus"/>
                    </div>
                </div>
